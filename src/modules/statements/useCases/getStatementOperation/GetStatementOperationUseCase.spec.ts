...
describe("Get statement operation", () => {
  ...
  it('should be able to get the statement operation', async () => {
    ...
    const responseStatement = await getStatementOperationUseCase.execute({ user_id: user.id as string, statement_id: statement.id as string })
  ...
  it('should not be able to get the statement operation with an invalid id', async () => {
    expect(async () => {
      ...
      await getStatementOperationUseCase.execute({ user_id: user.id as string, statement_id: 'test' })
  ...
  it('should not be able to get the statement operation with an invalid user id', async () => {
    expect(async () => {
      ...
      await getStatementOperationUseCase.execute({ user_id: 'id', statement_id: statement.id as string })
